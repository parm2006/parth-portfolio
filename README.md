...
## 💡 Coming Soon & Project Concepts

| Concept | Status | Description |
| :--- | :---: | :--- |
| **IdeaQueue** | 💡 | Productivity app concept for fast mobile idea capture, database persistence, and surfacing top-priority thoughts via priority queues. |
| **FossilCV** | 💡 | Computer vision project for classifying fossil images and returning fossil types, confidence scores, and educational metadata. |
| **Particle** | 💡 | Research discovery feed platform ("YouTube for scientific papers") designed for browsing, saving, and recommending academic papers. |
